...
public class DashboardActivity extends AppCompatActivity {
    ...
    public void getToken() {
        ...
        AuthorizationClient.openLoginActivity(DashboardActivity.this, AUTH_TOKEN_REQUEST_CODE, request);

    }

    public void getCode() {
        final AuthorizationRequest request = getAuthenticationRequest(AuthorizationResponse.Type.CODE);
        AuthorizationClient.openLoginActivity(DashboardActivity.this, AUTH_CODE_REQUEST_CODE, request);
    }
    ...
    public void onGetUserProfileClicked() {
        ...
        mCall.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Toast.makeText(DashboardActivity.this, "Failed to fetch data, watch Logcat for more details",
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    Toast.makeText(DashboardActivity.this, "Failed to parse data, watch Logcat for more details",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
